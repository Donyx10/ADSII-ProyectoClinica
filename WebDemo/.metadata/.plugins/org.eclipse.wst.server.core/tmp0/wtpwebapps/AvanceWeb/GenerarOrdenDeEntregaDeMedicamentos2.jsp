...
<body>
	...
	<div class="container"
		style="padding-top: 10px; line-height: 0.8; padding-left: 0.01px;">
		...
		<form action="generarCita" id="id_form">
			<div class="form-group row">
				<div class="col-md-6">
					...
					<div class="form-group row" align="left" id="Entrega">
						<div class="col-md-12">
							<fieldset>
					...
					<br>
					<div class="form-group row" align="left" id="medicametos">
						<div class="col-md-12">
							<fieldset>
								...
								<div class="row">
									...
									<div class="col-md-7">
										<input class="form-control input-sm" type="text"
											value="VITAMINA C" id="" name="" readonly="readonly"
											placeholder="">
									</div>
								</div>
								<br>
								...
								<div class="row">
									...
									<div class="col-md-7">
										<input class="form-control input-sm" type="text"
											name="quantity" value="S/.30.00" readonly="readonly">
									</div>
								</div>
								<br>
								<div class="row">
									...
									<div class="col-md-3">
										<button type="submit" class="btn btn-success">
											Agregar Medicamento <i class="glyphicon glyphicon-plus"></i>
										</button>
									</div>
								</div>
							</fieldset>
