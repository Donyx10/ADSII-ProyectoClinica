	...
	<div class="container" style="padding-top: 20px;">
		...
		<form action="generarCita" id="id_form">
			<div class="row">
						...
						<div class="col-md-13">
							<fieldset>
								...
								<div class="row">
									...
									<div class="col-md-5">
										<input class="" type="text" value="2000222222" id=""
								...
								<div class="row">
									...
									<div class="col-md-7">
										<input class="" type="text" value="DONNADONY MOLLO QUICANO"
								...
								<div class="row">
									...
									<div class="col-md-5">
										<input class="" type="text" value="AV LOS EDITORES 293" id=""
											name="" placeholder="Ingrese la direccion">
									</div>
									<br>
								</div>
							</fieldset>
						...
						<div class="col-md-13">
							<fieldset>
								...
								<div class="row">
									...
									<div class="col-md-3">
										<input class="" type="text" id="" name="" value="001-000029"
								...
								<div class="row">
									...
									<div class="col-md-3">
										<input class="" type="text" id="" value="5/18/2018" name=""
											placeholder="Dia" size="10">
									...
									<div class="col-md-3">
										<input class="" type="text" id="" name="" value="17:50"
											placeholder="Hora" size="10">
				...
				<div class="col--1"
					style="background-color: lightblue; position: relative;"></div>
										...
										<table class="table table-fixed">
											<thead>
												<tr>
													...
													<th class="col-xs-3">Cod. Paciente</th>
						...
						<div class="col-md-13">
							<fieldset>
								...
								<div class="row">
									...
									<div class="col-md-1">
										<input class="" type="text" id="id_codigo" name="" value="30"
											placeholder="Dia" size="2">
									...
									<div class="col-md-1">
										<input class="" type="text" id="" name="" value="06"
											placeholder="Cantidad" size="2">
